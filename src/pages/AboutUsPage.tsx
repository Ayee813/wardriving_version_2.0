    ...
    <div className="min-h-screen">
      <div className="relative w-full h-[865px]">
        ...
        <div className="absolute inset-0 flex justify-center items-center flex-col z-10">
          <h1 className="text-white text-6xl font-bold">CEIT CYBER SECURITY</h1>
      ...
      {/* About section */}
      <section className="py-20 bg-white max-w-full">
        {/* block 1 */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 px-10 mb-20 mr-150">
          <img
            src={test}
            alt="img"
            className="object-cover h-80 w-80 rounded-2xl shadow-lg"
          />
        ...
        {/* block 2 */}
        <div className="flex flex-col md:flex-row-reverse items-center justify-center gap-10 px-10 mb-20 ml-150">
          <img
            src={test3}
            alt="img"
            className="object-cover h-80 w-80 rounded-2xl shadow-lg"
        ...
        {/* block 3 */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-10 px-10 mr-150">
          <img
            src={test4}
            alt="img"
            className="object-cover h-80 w-80 rounded-2xl shadow-lg"
